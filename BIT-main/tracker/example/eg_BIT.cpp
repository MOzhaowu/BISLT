...
int main(int argc, char *argv[])
{
	...
	diagnostics << "frame_index,model_version_used,model_version_after,model_reloaded_after_frame,tracking_time_ms,data_group_valid,"
				...
				<< "visible_boundary_ratio,occlusion_ratio,effective_contour_ratio,silhouette_iou,"
				<< "contour_residual_stddev,contour_residual_p90,contour_residual_centroid_offset,"
				<< "pose_diagnostics_time_ms,hessian_diagnostics_time_ms,contour_search_lines,active_contour_lines,"
				<< "matched_contour_lines,"
	...
	for (auto ip : ips)
	{
		...
		diagnostics << index << "," << modelVersionUsed << "," << cur_model_deformed_nums << ","
					...
					<< pRes->trackingResult->dataGroup.visible_boundary_ratio << ","
					<< pRes->trackingResult->dataGroup.occlusion_ratio << ","
					<< pRes->trackingResult->dataGroup.effective_contour_ratio << ","
					<< pRes->trackingResult->dataGroup.silhouette_iou << ","
					<< pRes->trackingResult->dataGroup.contour_residual_stddev << ","
					<< pRes->trackingResult->dataGroup.contour_residual_p90 << ","
					<< pRes->trackingResult->dataGroup.contour_residual_centroid_offset << ","
					<< pRes->trackingResult->dataGroup.pose_diagnostics_time_ms << ","
					<< pRes->trackingResult->dataGroup.hessian_diagnostics_time_ms << ","
					<< pRes->trackingResult->dataGroup.contour_search_lines << ","
					<< pRes->trackingResult->dataGroup.active_contour_lines << ","
					<< pRes->trackingResult->dataGroup.matched_contour_lines << ","
