#ifndef __AR3DVTOOLS_STATISTICS_H__
#define __AR3DVTOOLS_STATISTICS_H__
...
ar3dv::StatsCollector my_statistics("My Statistics");
...
#endif //__AR3DVTOOLS_STATISTICS_H__