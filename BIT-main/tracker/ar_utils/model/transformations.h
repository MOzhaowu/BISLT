#ifndef AR3DVENGINE_TRANSFORMATIONS_H
#define AR3DVENGINE_TRANSFORMATIONS_H
...
namespace ar3dv
{
	...
	public:
		 ...
		 */
		static cv::Matx44f
		lookAtMatrix(float ex, float ey, float ez, float cx, float cy, float cz, float ux, float uy, float uz);
		 ...
		 */
		static cv::Matx44f
		perspectiveMatrix(const cv::Matx33f &K, int width, int height, float zNear, float zFar, bool flipY = false);
...
#endif // AR3DVENGINE_TRANSFORMATIONS_H
