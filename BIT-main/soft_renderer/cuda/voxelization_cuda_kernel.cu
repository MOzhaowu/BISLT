...
std::vector<at::Tensor> voxelize_sub1_cuda(
    ...
    #endif
    AT_DISPATCH_FLOATING_TYPES(faces_type, "voxelize_sub1_cuda", ([&] {
...
std::vector<at::Tensor> voxelize_sub2_cuda(
    ...
    const dim3 blocks ((batch_size * num_faces - 1) / threads +1);
        ...
        auto faces_type = faces.type();  // no longer supported in new C++/CUDA extension of pytorch
    #endif
    AT_DISPATCH_FLOATING_TYPES(faces_type, "voxelize_sub2_cuda", ([&] {
...
std::vector<at::Tensor> voxelize_sub3_cuda(
    ...
    const dim3 blocks ((batch_size * voxel_size  * voxel_size  * voxel_size - 1) / threads +1);
        ...
        auto faces_type = faces.type();  // no longer supported in new C++/CUDA extension of pytorch
    #endif
    AT_DISPATCH_FLOATING_TYPES(faces_type, "voxelize_sub3_cuda", ([&] {
...
std::vector<at::Tensor> voxelize_sub4_cuda(
    ...
    const dim3 blocks ((batch_size * voxel_size  * voxel_size  * voxel_size - 1) / threads +1);
        ...
        auto faces_type = faces.type();  // no longer supported in new C++/CUDA extension of pytorch
    #endif
    AT_DISPATCH_FLOATING_TYPES(faces_type, "voxelize_sub4_cuda", ([&] {
